...
| `textSecondary` | `#5C5470` | Supporting body text, secondary descriptions |
| `textMuted` | `#9890A8` | Page subtitles (e.g. "Welcome back to {BRAND.name}"), timestamps, metadata, empty-state icons |
